...
class AbsTask(ABC):
    ...
    def get_parser(cls) -> config_argparse.ArgumentParser:
        ...
        group.add_argument(
            ...
            action=NestedDictAction,
            default=dict(),
            help="Config which must contain sniper_dir and schedule (other SNIPER args are optional)",
        )
    ...
    def main_worker(cls, args: argparse.Namespace):
        ...
        if (
            ...
            # 3. Build optimizer
            if args.sniper_conf:
                param_groups = [{"name": name, "params": param} for name, param in model.named_parameters()]
            else:
                param_groups = None
        ...
        if args.dry_run:
            ...
            if args.sniper_conf:
                ...
                sniper_conf["model_builder"] = functools.partial(cls.build_model, args)
                sniper_conf["optim_lr"] = args.optim_conf["lr"]
            else:
                sniper_conf = {}
